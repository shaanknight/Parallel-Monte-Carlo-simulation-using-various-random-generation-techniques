...
export SRCDIR=/home/shaanknight/Distributed_Systems/openmpi-1.10.7/ompi/contrib/vt/vt/config/mpigen
...
outprefix=/home/shaanknight/Distributed_Systems/openmpi-1.10.7/ompi/contrib/vt/vt/vtlib/vt_mpireg.gen
tmp=tmp$$
...
mawk -f $tmp.awk -F, <$tmp.tmp >>$tmp.h
...
mawk -f $tmp.awk -F, <$tmp.tmp >>$tmp.c
if test $? -ne 0; then exit $?; fi
