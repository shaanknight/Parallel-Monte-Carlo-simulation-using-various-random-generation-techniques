...
#define HAVE_DEVPOLL 0

/* Define to 1 if you have the <dlfcn.h> header file. */
#define HAVE_DLFCN_H 1

/* whether we want DNS support */
#define HAVE_DNS test "$enable_dns" = "yes"
...
/* whether we want HTTP suport */
#define HAVE_HTTP test "$enable_http" = "yes"
...
/* whether we want RPC suport */
#define HAVE_RPC test "$enable_rpc" = "yes"
...
/* Define if there is a working event op */
#define HAVE_WORKING_EVENTOPS 1
